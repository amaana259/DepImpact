...
import pagerank.InferenceReputationForward;
...
public class ProcessOneLogCmd {
    ...
    public static void process(String resultDir, String suffix, double threshold, boolean trackOrigin, String logfile, String[] IP, String detection, String[] highRP, String[] midRP, String[] lowRP, String filename, double detectionSize, Set<String> seedSources, String[] criticalEdges, String mode, String do_split) {
        ...
        try {
            ...
            double timeCost = ProcessOneLogCmd.getTimeCost(startTime, endTime);
            System.out.println("Build Original Graph time cost is: " + timeCost);
            os.write(("Build Original Graph time cost is: " + timeCost + "\n").getBytes());
            ProcessOneLogCmd.run_exp(orignal, resultDir, suffix, threshold, trackOrigin, logfile, IP, detection, highRP, midRP, lowRP, filename, detectionSize, seedSources, criticalEdges, mode, do_split);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void process_forward(String resultDir, String suffix, double threshold, boolean trackOrigin, String logfile, String[] IP, String detection, String[] highRP, String[] midRP, String[] lowRP, String filename, double detectionSize, Set<String> seedSources, String[] criticalEdges, String mode) {
        ...
        try {
            ...
            System.out.println("Build Original Graph time cost is: " + timeCost);
            os.write(("Build Original Graph time cost is: " + timeCost + "\n").getBytes());
            ProcessOneLogCmd.run_exp_forward(orignal, resultDir, suffix, threshold, trackOrigin, logfile, IP, detection, highRP, midRP, lowRP, filename, detectionSize, seedSources, criticalEdges, mode);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void process_backward(String resultDir, String suffix, double threshold, boolean trackOrigin, String logfile, String[] IP, String detection, String[] highRP, String[] midRP, String[] lowRP, String filename, double detectionSize, Set<String> seedSources, String[] criticalEdges, String mode) {
        ...
        try {
            ...
            System.out.println("Build Original Graph time cost is: " + timeCost);
            os.write(("Build Original Graph time cost is: " + timeCost + "\n").getBytes());
            ProcessOneLogCmd.run_exp_backward(orignal, resultDir, suffix, threshold, trackOrigin, logfile, IP, detection, highRP, midRP, lowRP, filename, detectionSize, seedSources, criticalEdges, mode);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void run_exp_forward(DirectedPseudograph<EntityNode, EventEdge> orignal, String resultDir, String suffix, double threshold, boolean trackOrigin, String logfile, String[] IP, String detection, String[] highRP, String[] midRP, String[] lowRP, String filename, double detectionSize, Set<String> seedSources, String[] criticalEdges, String mode) {
        ...
        try {
            ...
            DirectedPseudograph<EntityNode, EventEdge> forwardRes = forwardAnalysis.fowardTrack(detection, 10);
            long end = System.currentTimeMillis();
            double timeCost = ProcessOneLogCmd.getTimeCost(start, end);
            ...
            timeCost = ProcessOneLogCmd.getTimeCost(start, end);
            ...
            InferenceReputationForward infer = new InferenceReputationForward(split2.inputGraph);
